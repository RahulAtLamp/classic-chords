...
const Communication = (streamId) => {
    ...
    const getConversation = async () => {
        ...
        const signer = new ethers.Wallet("0x567514509ca3de736e96d064a40356b437b5bfc9a7878eea4cb786b50f76a024", getDefaultProvider());
            ...
            <>
                {
                    client
                        ...
                        <div className="message__main">
                            ...
                            <ConversationRight allMessages={allMessages} activeAddress={activeAddress} sendMessage={sendMsg} singleMessage={singleMessage} setSingleMessage={setSingleMessage} />
                        </div>
                        :
                        null
                }

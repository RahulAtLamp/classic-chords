    ...
    <div className="data-load">
      <div className="load-inner">
        ...
        >
          <g>
            <g className="right-heart">
              <path
                style={{ fill: "#E86464" }}
                d="M416.923,0c-12.972,0-24.716,5.249-33.231,13.736C375.177,5.249,363.434,0,350.462,0
		...
		C464,21.077,442.923,0,416.923,0z"
              ...
              <path
                style={{ fill: "#D25055" }}
                d="M360.074,0.99C356.97,0.345,353.757,0,350.462,0c-26,0-47.077,21.077-47.077,47.077
		c0,36,42.231,79.269,80.308,96.923C347.692,106.615,319.421,27.761,360.074,0.99z"
            ...
            <g className="right-bottom-heart">
              <path
                style={{ fill: "#E86464" }}
                d="M366.61,171.887c0.677,0.439,1.328,0.905,1.948,1.4C367.938,172.792,367.288,172.325,366.61,171.887
		z"
              />
              <path
                style={{ fill: "#E86464" }}
                d="M364.394,170.609c0.753,0.381,1.476,0.797,2.169,1.244
		C365.869,171.407,365.146,170.99,364.394,170.609z"
              />

              <path
                style={{ fill: "#E86464" }}
                d="M394.774,186c-5.93-3.004-12.513-3.324-18.371-1.417c-1.437-4.365-4.116-8.32-7.844-11.296
		c-24.782,2.823-30.12,45.415-22.321,70.84c21.493,0.748,50.817-9.251,59.154-25.707C411.412,206.536,406.658,192.021,394.774,186z"
              ...
              <path
                style={{ fill: "#D25055" }}
                d="M368.558,173.288L368.558,173.288L368.558,173.288c-0.62-0.495-1.271-0.962-1.948-1.4
		...
		c-8.337,16.456,0.947,46.014,14.264,62.901C338.438,218.702,343.776,176.111,368.558,173.288z"
            ...
            <g className="left-top-heart">
              <path
                style={{ fill: "#E86464" }}
                d="M246.477,92.229c16.865-16.565,31.091-47.505,24.285-66.606
		...
		c1.748-0.623,3.518-1.047,5.287-1.292C190.402,42.707,220.309,79.2,246.477,92.229z"
              ...
              <path
                style={{ fill: "#D25055" }}
                d="M246.477,92.229C220.309,79.2,190.402,42.707,206.91,20.818c-1.769,0.245-3.539,0.669-5.287,1.292
		c-13.795,4.915-20.993,20.083-16.078,33.877C192.351,75.087,222.938,90.061,246.477,92.229z"
            ...
            <g className="loading-note">
              <path
                style={{ fill: "#DEE1E9" }}
                d="M266.793,118.49l-149.206,33.156C95.625,156.527,80,176.006,80,198.504v189.397
		...
		C296,126.564,281.782,115.16,266.793,118.49z"
              ...
              <path
                style={{ fill: "#CACDD2" }}
                d="M32,424c0-18.908,15.762-34.713,36.923-38.887C64.768,384.411,60.456,384,56,384
		...
		c3.277-0.149,6.472-0.511,9.579-1.036C47.762,458.713,32,442.908,32,424z"
              ...
              <path
                style={{ fill: "#CACDD2" }}
                d="M216,376c0-18.908,15.762-34.713,36.923-38.887C248.768,336.411,244.456,336,240,336
		c-30.928,0-56,17.908-56,40s25.072,40,56,40c1.11,0,2.211-0.026,3.303-0.075c0.014-0.001,0.027-0.002,0.041-0.002
